...
CoverArtNew::CoverArtNew(QObject *parent, DB_functions_t *api) : ICoverArtBackend(parent) {
    db = api;
...
CoverArtLegacy::CoverArtLegacy(QObject *parent, DB_functions_t *api) : ICoverArtBackend(parent) {
    db = api;
