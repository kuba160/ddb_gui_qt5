...
Item {
    ...
    Component {
        ...
        MenuItem {
            ...
            onTriggered: {
                DBApi.actions.execAction(modelData.id)
            }

            Component.onCompleted: {
                menu_track.implicitWidth = Math.max(menu_track.implicitWidth, implicitWidth)
            }
        }
    }
    ...
    Component.onCompleted: {
        let l = DBApi.actions.parsePrototype(prototype_id)
